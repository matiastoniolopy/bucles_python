...
for numero in temp_dataloger:
    ...
    print("numero=", numero, "sumatoria=", temperatura_sumatoria)


temperatura_max = max(temp_dataloger)
print("temperatura maxima es", temperatura_max)
temperatura_min = min(temp_dataloger)
print("temperatura minima es", temperatura_min)
temperatura_promedio = sum(temp_dataloger) / len(temp_dataloger)
print("temperatura promedio es", temperatura_promedio)
temperatura_len = len(temp_dataloger)
print("cantidad de temperaturas es", temperatura_len)
